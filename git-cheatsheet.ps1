...
function Show-Header {
    ...
    Write-Host "Git Version: $(git --version 2>&1)" -ForegroundColor White
...
function Show-GitCommands {
    ...
    Write-Host "  git tag v1.0.0                     # Create tag" -ForegroundColor White
}
...
Write-Host "💡 Tip: Add this script to your PATH for easy access" -ForegroundColor Yellow
 # запуск кода
 .\git-cheatsheet.ps1